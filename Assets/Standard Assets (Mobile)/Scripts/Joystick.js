...
static private var tapTimeDelta : float = 0.2;				// Time allowed between taps
...
var tapCount : int;
var tapTimeWindow :float;										// Current tap count

private var lastFingerId = -1;								// Finger last used for this joystick							// How much time there is left for a tap to occur
private var fingerDownPos : Vector2;
var fingerDownTime : float;
private var firstDeltaTime : float = 0.1;
